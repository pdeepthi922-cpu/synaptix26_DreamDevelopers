    ...
    return (
        <DashboardLayout role="recruiter">
            <div className="max-w-2xl animate-fade-in space-y-6">
                ...
                <h1 className="text-2xl font-bold font-heading">Post New Project</h1>

                <form onSubmit={handleSubmit} className="bg-card border border-border rounded-xl p-6 shadow-sm space-y-5">
                    <div className="space-y-1"><label className="text-sm font-medium">Project Name</label><Input required placeholder="e.g., E-Commerce Platform" /></div>
                    <div className="space-y-1"><label className="text-sm font-medium">Description</label><Textarea required placeholder="Describe the project goals and scope..." rows={4} /></div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1"><label className="text-sm font-medium">Project Deadline</label><Input type="date" required /></div>
                    </div>
                    ...
                    <Button type="submit" className="w-full" size="lg">Post Project</Button>
                </form>
            </div>
        </DashboardLayout>
    );
